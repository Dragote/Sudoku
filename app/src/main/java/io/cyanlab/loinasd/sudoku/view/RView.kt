...
/*    constructor(context: Context, attrs: AttributeSet) : super(context, attrs) {
    ...
    private fun init(attrs: AttributeSet?, defStyle: Int) {
        ...
        val a = context.obtainStyledAttributes(
                attrs, R.styleable.RView, defStyle, 0)

        mExampleString = a.getString(
                R.styleable.RView_exampleString)
        mExampleColor = a.getColor(
                R.styleable.RView_exampleColor,
                mExampleColor)
        // Use getDimensionPixelSize or getDimensionPixelOffset when dealing with
        // values that should fall on pixel boundaries.
        mExampleDimension = a.getDimension(
                R.styleable.RView_exampleDimension,
                mExampleDimension)

        if (a.hasValue(R.styleable.RView_exampleDrawable)) {
            exampleDrawable = a.getDrawable(
                    R.styleable.RView_exampleDrawable)
